...
class Bee(Mosquito):
    def __init__(self):
        ...
        self.images = [image.load(r"C:\Users\ABC\Downloads\source-code-mosquito-game\source code\Assets\bee\1.png", size=size, flip=moving_direction=="right") for nb in range(1, 7)] # load the images
