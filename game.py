...
class Game:
    def __init__(self, surface):
        ...
        self.sounds = {}
        self.sounds["slap"] = pygame.mixer.Sound(r"C:\Users\ABC\Downloads\source-code-mosquito-game\source code\Assets\Sounds\slap.wav")
        self.sounds["slap"].set_volume(SOUNDS_VOLUME)
        self.sounds["screaming"] = pygame.mixer.Sound(r"C:\Users\ABC\Downloads\source-code-mosquito-game\source code\Assets\Sounds\screaming.wav")
