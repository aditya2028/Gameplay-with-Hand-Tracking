...
class Hand:
    def __init__(self):
        self.orig_image = image.load(r"C:\Users\ABC\Downloads\source-code-mosquito-game\source code\Assets\hand.png", size=(HAND_SIZE, HAND_SIZE))
        self.image = self.orig_image.copy()
        self.image_smaller = image.load(r"C:\Users\ABC\Downloads\source-code-mosquito-game\source code\Assets\hand.png", size=(HAND_SIZE - 50, HAND_SIZE - 50))
