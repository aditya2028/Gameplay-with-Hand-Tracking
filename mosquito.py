...
class Mosquito:
    def __init__(self):
        ...
        self.images = [image.load(r"C:\Users\ABC\Downloads\source-code-mosquito-game\source code\Assets\mosquito\mosquito.png", size=size, flip=moving_direction=="right")]
